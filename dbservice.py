...
DB_HOST = 'dpg-ck01lj15mpss73btt51g-a.singapore-postgres.render.com'
DB_NAME = 'youtube_data_r8zs'
DB_USER = 'suresh'
DB_PASSWORD = 'HtY8nhhP7p4M5O0br7sEeGzaX8ooOHlD'
...
def sql_create_tables():
    sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q1_allvideoname_channelname():
    q1_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q2_channelname_totalvideos():
    q2_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q3_mostviewvideos_channelname():
    q3_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q4_videonames_totalcomments():
    q4_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q5_videonames_highestlikes_channelname():
    q5_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q6_videonames_totallikes_channelname():
    q6_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q7_channelnames_totalviews():
    q7_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q8_channelnames_releasevideos(year):
    q8_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q9_channelnames_avgvideoduration():
    q9_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
...
def q10_videonames_channelnames_mostcomments():
    q10_sqlconn = psycopg2.connect(host=DB_HOST, port=5432, user=DB_USER, password=DB_PASSWORD, database=DB_NAME)
